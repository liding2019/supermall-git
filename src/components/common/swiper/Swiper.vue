<template>
    <div id="hy-swiper">
        <div class="swiper" @touchstart="touchStart" @touchmove="touchMove" @touchend="touchEnd" ref="cusSwiper">
            <slot></slot>
        </div>
      ...
      methods:{
        ...
        handleDom:function () {
         ...
         // let swiperEl=document.querySelector(".swiper");
          let swiperEl=this.$refs.cusSwiper;
        ...
        touchMove:function (e) {
          ...
          let moveDistance=this.distance+currentPositon;
